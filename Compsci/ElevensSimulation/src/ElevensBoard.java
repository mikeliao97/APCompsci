/* Name; Qin LIao
 * Period: 7
 * Time Spent: 20 minutse
 * REflection: This lab was pretty easy. Instead of returning true of false, you
 * simply return a list, and then check whether the array list contains more than
 * 0 elements for true. and 0 for false. The only part that was hard about this lab
 * was the part where you had to use replaceSelectedCards(cIndexes), it took a
 * while for me to find this method but that was the only part that was even
 * slightly difficult. 
 * 
 * 
 * 
